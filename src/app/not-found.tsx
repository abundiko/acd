...
export default function NotFound() {
  return (
    <main className="h-full w-full flex items-center justify-center flex-col gap-5 p-10 md:p-20 text-center">
      <h1 className="font-extrabold text-red-900 text-5xl">404</h1>
