        ...
        <div className="hero_content container">
            <div className="hero-lft-txt">
                ...
                <div className="hero_innercontent">
                    ...
                    <a href="#" title="Verify Acessibility" id="mobileaccess">Verify Accessibility</a>
                    <div className="verify_accesibility">
                        <p>Verify Accessibility</p>
                        <form action="#" method="post" id="verification_process">
                            ...
                            <datalist id="state">
                                ...
                                <option value="Taraba">&rsquo;s Gift to the Nation</option>
