  ...
  useEffect(()=>{
    ...
    window.speechSynthesis.cancel()
      setTimeout(() => {
        ...
        }else if(['input','textarea'].includes(tag.tagName.toLocaleLowerCase())) {
    ...
    tags.forEach((tag:any)=>{
      if(
        ...
        !['button','a', 'p'].includes(tag.parentElement?.tagName.toLowerCase())
      ) {
...
<path d="M17 18V26" stroke="#107BEF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
<path d="M14 20V24" stroke="#107BEF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M11 21V23" stroke="#107BEF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M20 20V24" stroke="#107BEF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M23 21V23" stroke="#107BEF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
