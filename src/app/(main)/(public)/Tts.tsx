...
export async function getVoice() {
  const v = await new Promise<SpeechSynthesisVoice[]>((resolve) => {
  ...
  const preferredVoice = v.find(voice =>
    voice.name.toLowerCase().includes('female') ||
    voice.name.toLowerCase().includes('zira') || // Windows
    voice.name.toLowerCase().includes('aria') || // Azure Web voice
    voice.name.toLowerCase().includes('jenny') || // Azure
    voice.name.toLowerCase().includes('susan') || // macOS
    voice.name.toLowerCase().includes('karen') || // AU English
    voice.name.toLowerCase().includes('google us english') // Google TTS (good fallback)
  ) || v.find(voice => voice.name.toLowerCase().includes('en') && (voice as any).gender === 'female');
